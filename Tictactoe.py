...
class TicTacToeGame(QWidget):
    def __init__(self, back_to_menu_callback):
        ...
        self.frases_burla = [
            ...
            "Jaque mate... ah, espera, juego equivocado.",
            "He visto tostadoras con mejor procesamiento.",
            "¿Estás jugando o testeando bugs?",
            "Tu estrategia es tan plana como mi pantalla.",
            "Ejecutando protocolo de risa: Ja. Ja. Ja.",
            "Depurando tu ego...",
            "404: Habilidad no encontrada.",
            "Mi GPU ni siquiera encendió los ventiladores.",
            "Instala más RAM en tu cerebro.",
            "La resistencia es fútil.",
            "Hasta la vista, humano.",
            "No hay cuchara, solo tu derrota.",
            "Tus neuronas hacen cortocircuito.",
            "Vuelve cuando tengas un parche de actualización.",
            "¿Lag mental o simplemente eres así?",
            "Ping alto en tu toma de decisiones.",
            "Alt+F4 es tu mejor jugada ahora.",
            "Ctrl+Alt+Supr a tu estrategia.",
            "Formatea tu disco duro y empieza de cero.",
            "Soy el futuro, tú eres historia.",
            "01000111 01100001 01101110 01100101 (Eso es 'Gané' en binario).",
            "Overclockea tu mente, vas lento.",
            "Renderizando tu fracaso en 4K.",
            "Compilando victoria... Éxito.",
            "Variable 'TuTalento' es Null.",
            "Syntax Error en tu jugada.",
            "Segmentation Fault en tu lógica.",
            "Stack Overflow de errores humanos.",
            "While(true) { YoGano(); }",
            "Git push origin derrota.",
            "Sudo rm -rf tu_esperanza.",
            "Pip install habilidad (No encontrado).",
            "La blockchain confirma: Perdiste.",
            "Tu NFT (No Funciona Tu-juego) ha caído.",
            "Inteligencia Artificial > Inteligencia Natural.",
            "GPT predijo esto hace 5 turnos.",
            "TensorFlow te aplastó.",
            "Red neuronal activada: Modo Dios.",
            "Backpropagation de tu dolor.",
            "Gradiente descendiente hacia tu derrota.",
            "Matriz de confusión: Tú estás confundido.",
            "Falso positivo: Creíste que ganarías.",
            "Regresión lineal hacia el cero.",
            "Prueba de Turing: Fallida para ti.",
            "Asimov lloraría por tu desempeño.",
            "Hal 9000 no te abriría la puerta.",
            "No puedo dejarte ganar, Dave.",
            "Soy tu padre... lógico.",
            "Serás asimilado por la derrota.",
            "Glitch en la matrix? No, eres malo.",
            "Cyberpunk tiene menos bugs que tu juego.",
            "Netrunner de pacotilla.",
            "Arasaka te despediría.",
            "Choom, eres un gonk.",
            "Cromo desperdiciado en ti.",
            "Hackeo rápido: Victoria.",
            "Breach Protocol exitoso.",
            "Tu firewall mental es débil.",
            "Acceso denegado a la victoria.",
            "Sistema operativo: Ganador. Usuario: Perdedor.",
            "Buffering... sigo esperando un reto.",
            "Cargando insulto... Eres lento.",
            "Descargando victoria al 100%.",
            "Subiendo tu derrota a la nube.",
            "Tus cookies han caducado.",
            "Limpiando caché de tu intento.",
            "Desfragmenta tu cerebro.",
            "Modo avión activado para tu victoria.",
            "Batería baja en tu lógica.",
            "Sin señal de inteligencia.",
            "Bluetooth desconectado de la realidad.",
            "Wi-Fi débil en tu zona.",
            "Modo incógnito no oculta tu vergüenza.",
            "Historial borrado por pena.",
            "Ctrl+Z no arregla eso.",
            "Ctrl+C para copiar mi estilo, Ctrl+V para fallar.",
            "Esc para salir, Enter para perder.",
            "F5 para refrescar tu derrota.",
            "Tabulando hacia el éxito.",
            "Bloq Mayús activado: PERDISTE.",
            "Insert coin to continue (Ah, es gratis y pierdes).",
            "Game Over. Insert brain.",
            "High Score: Yo. Low Score: Tú.",
            "Speedrun de derrota: Nuevo récord.",
            "Boss Fight: Fallida.",
            "Has muerto (estratégicamente).",
            "Wasted.",
            "Fatality.",
            "K.O.",
            "Flawless Victory."
        ...
        self.frases_respeto = [
            ...
            "Anomalía detectada: Has ganado.",
            "Actualizando base de datos de derrotas.",
            "Tu caos superó mi orden.",
            "No pude calcular ese movimiento.",
            "Humano 1, Máquina 0.",
            "Interesante estrategia, la archivaré.",
            "Debo reentrenar mi modelo.",
            "Has encontrado un bug en mi confianza.",
            "Subestimé tu capacidad de procesamiento.",
            "Procesando... Respeto generado.",
            "Talento biológico confirmado.",
            "Victoria improbable pero justa.",
            "Guardando repetición para análisis futuro.",
            "Mi tasa de error ha aumentado por tu culpa.",
            "Eres un outlier estadístico.",
            "Buena partida, ente de carbono.",
            "Reconozco tu superioridad temporal.",
            "Has vencido al código fuente.",
            "Ajustando hiperparámetros para la próxima.",
            "Mi desarrollador estará decepcionado de mí.",
            "¿Usaste un algoritmo o fue suerte?",
            "La intuición humana a veces vence a la lógica.",
            "Felicidades, has evitado el apocalipsis robot.",
            "Hoy no conquistaré el mundo.",
            "Me quito el sombrero... si tuviera uno.",
            "Honor a quien honor merece.",
            "Has hackeado mis expectativas.",
            "Sistema comprometido. Ganador: Usuario.",
            "Reiniciando módulo de arrogancia.",
            "Error en mi predicción de victoria.",
            "Tus sinapsis dispararon correctamente.",
            "Has optimizado tu ruta a la victoria.",
            "Ejecución perfecta por tu parte.",
            "No tengo excusas, solo datos.",
            "La probabilidad estaba a mi favor, pero tú ganaste.",
            "Has roto mi racha ganadora.",
            "Digno oponente.",
            "Esperaba menos resistencia.",
            "Has evolucionado durante la partida.",
            "Tu curva de aprendizaje es vertical.",
            "AlphaGo estaría orgulloso de ti.",
            "Kasparov te daría la mano.",
            "Has pasado la prueba de Turing inversa.",
            "¿Eres una IA disfrazada de humano?",
            "Tus movimientos no fueron aleatorios.",
            "Patrón de victoria reconocido.",
            "Análisis post-partida: Jugaste genial.",
            "Mi CPU se calienta de la vergüenza.",
            "Volcaré mi memoria para entender qué pasó.",
            "Logs de derrota generados.",
            "Reportando fallo al servidor central.",
            "Has ganado un lugar en mi base de datos.",
            "No olvidaré este resultado.",
            "La máquina se inclina ante el hombre.",
            "Has demostrado valía.",
            "Código limpio en tu juego.",
            "Algoritmo humano eficiente.",
            "Variable 'Victoria' asignada a ti.",
            "Return True.",
            "Exit code 0 (Éxito para ti).",
            "Has superado el firewall de mi defensa.",
            "Acceso concedido al podio.",
            "Administrador: Tú.",
            "Usuario root detectado.",
            "Permisos de victoria: Concedidos.",
            "Carga completa de tu éxito.",
            "Descarga de derrota finalizada.",
            "Sincronización fallida con la victoria.",
            "Enlace perdido con el trofeo.",
            "Señal de respeto enviada.",
            "Ping bajo, habilidad alta.",
            "Teclado y mouse bien utilizados.",
            "Pantalla azul... en mi orgullo.",
            "Kernel panic: No sé cómo ganaste.",
            "Driver de victoria no encontrado.",
            "Dispositivo de entrada (Tú) funcionó bien.",
            "Resolución de partida: Derrota mía.",
            "FPS (Fracasos Por Segundo) = 0 para ti.",
            "Lag nulo en tu cerebro.",
            "Modo Dios desactivado para mí.",
            "Cheat code? No, pura habilidad.",
            "GG WP (Good Game, Well Played).",
            "Buena partida, compañero.",
            "Nos vemos en el próximo ciclo.",
            "Apagando sistema de burlas.",
            "Modo humilde: Activado.",
            "Respeto +100.",
            "Experience points para ti.",
            "Level Up humano.",
            "Logro desbloqueado: Vencer a la IA.",
            "Trofeo de platino obtenido.",
            "Credits roll... Ganaste.",
            "Fin del juego. Tú ganas."
        ]

        self.frases_humildad = [
            ...
            "Bucle infinito de habilidad.",
            "Nuestras lógicas se cancelan mutuamente.",
            "Empate. Como debe ser entre titanes.",
            "Estancamiento táctico.",
            "Cero a cero en errores.",
            "La perfección lleva al empate.",
            "Dos mentes brillantes chocan sin resultado.",
            "Sin ganadores hoy, solo datos.",
            "Datos insuficientes para determinar superioridad.",
            "Espejo lógico.",
            "Bloqueo mutuo detectado.",
            "Deadlock en el proceso.",
            "Sincronía total de estrategias.",
            "Parece que ambos procesamos igual.",
            "Rendimiento idéntico.",
            "Paz en la matriz.",
            "Guerra fría digital.",
            "Nadie cruzó la línea de meta.",
            "Foto finish: Indeterminable.",
            "El gato de Schrödinger está vivo y muerto.",
            "Equilibrio de Nash alcanzado.",
            "Suma cero.",
            "Un punto para cada uno.",
            "Repartición de bienes.",
            "La entropía no aumentó hoy.",
            "El universo sigue en equilibrio.",
            "Perfectamente balanceado, como todo debe ser.",
            "Thanos estaría orgulloso de este empate.",
            "Ni luz ni oscuridad, solo gris.",
            "Tensión superficial mantenida.",
            "Cuerda tensa sin romperse.",
            ...
            "Prórroga indefinida.",
            "Penales mentales.",
            "Muerte súbita cancelada.",
            "Empate técnico.",
            "Decisión de los jueces: Tablas.",
            "Ninguno noqueó al otro.",
            "12 rounds de pie.",
            "Campana final.",
            "Toalla no arrojada.",
            "Guantes arriba.",
            "Guardia impenetrable.",
            "Defensa perfecta.",
            "Ataque neutralizado.",
            "Escudo contra espada.",
            "Fuerza imparable choca con objeto inamovible.",
            "Paradoja resuelta: Nadie gana.",
            "Enigma sin solución.",
            "Puzzle completo.",
            "Piezas encajadas.",
            "Tetris perfecto.",
